...
Then, you need a repository for you game. You can either wait for us to create one, or use [our template on Github](https://github.com/gamepark/board-chateau-combo) to [create a new repository](https://docs.github.com/fr/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template)
...
- `ChateauCombo` => `NameOfYourGame`
- `chateau-combo` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [ChateauComboRules.ts](/rules/src/ChateauComboRules.ts)
