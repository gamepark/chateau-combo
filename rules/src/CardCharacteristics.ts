...
export const cardCharacteristics: Record<number, CardPattern> = {
  ...
  [Card.Farmer]:             { cost: 5, blazon: [BlazonType.Farmer],                      canSwapMessengerToken: true, immediateEffect:[{type:ImmediateEffectType.GetKeys, value:1, condition: {blazon:[BlazonType.Farmer]}}], scoringEffect:{type:ScoringType.ByBlazon, value:2, blazonCondition:{blazonType:BlazonType.Farmer,line:true, column:true}}   } ,
