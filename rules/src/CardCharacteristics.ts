...
export const cardCharacteristics: Record<number, CardPattern> = {
  [Card.Steward]:            { cost: 0, blazon: [BlazonType.Noble],                       canSwapMessengerToken: false, scoringEffect:{type:ScoringType.ByGoldOnCard, value:2, limit:3} },
  ...
  [Card.Banker]:             { cost: 7, blazon: [BlazonType.Worker],                      canSwapMessengerToken: true, scoringEffect:{type:ScoringType.ByGoldOnAllCards}  } ,  // TODO : choose between, with gold on card
  ...
  [Card.Innkeeper]:          { cost: 0, blazon: [BlazonType.Worker],                      canSwapMessengerToken: false, scoringEffect:{type:ScoringType.ByGoldOnCard, value:2, limit:6} }, // TODO 
  ...
  [Card.Potter]:             { cost: 2, blazon: [BlazonType.Worker, BlazonType.Worker],   canSwapMessengerToken: true, scoringEffect:{type:ScoringType.ByGoldOnCard, value:2, limit:4}  } , // TODO
  ...
  [Card.Beekeeper]:          { cost: 2, blazon: [BlazonType.Farmer],                      canSwapMessengerToken: false, scoringEffect:{type:ScoringType.ByGoldOnCard, value:2, limit:9} }, // TODO
