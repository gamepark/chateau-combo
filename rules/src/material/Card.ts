...
export const isCastleType = (id: { front: Card, back: CardType }) => id.back === CardType.Castle
export const nobles = cards.filter(isNoble)
export const isVillage = (card: Card) => card >= Card.Inventor
export const isVillageType = (id: { front: Card, back: CardType }) => id.back === CardType.Village
